<?php
	...
	$conne->close_rst();
?>
<div style=" width:204px; height:20px; text-align:left; background-image:url(images/bbg.gif); background-position:left; background-repeat:repeat-x; text-indent: 8px; padding:2px;"><img src="images/header8.gif" border="0" width="13" height="13" />&nbsp;Õº∆¨∑÷¿‡</div>
