...
window.onload = function(){
	...
	$('regbtn').onclick = function(){
		...
		email1 = $('email').value;
		homepage1 = $('homepage').value;
		qq1 = $('qq').value;
		headgif1 = $('headgif').value;
		unwrite1 = $('unwrite').value;
		realname1 = $('realname').value;
		sex1 = $('sex').value;
		birthday1 = $('year').value+'-'+$('month').value+'-'+$('day').value;
		tel1 = $('tel').value;
		address1 = $('address').value;
		url = 'register_chk.php?name='+name+'&pwd='+pwd;
		url += '&question='+question1+'&answer='+answer1+'&email='+email1;
		url += '&homepage='+homepage1+'&qq='+qq1+'&headgif='+headgif1+'&unwrite='+unwrite1;
		url += '&realname='+realname1+'&sex='+sex1+'&birthday='+birthday1+'&tel='+tel1+'&address='+address1;
