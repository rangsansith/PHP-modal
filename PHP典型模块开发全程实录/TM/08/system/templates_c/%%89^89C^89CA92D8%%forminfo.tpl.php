<?php /* Smarty version 2.6.19, created on 2011-07-18 16:07:10
...
<input type="button" value="打印预览" onclick="printview()" class="btn" />&nbsp;&nbsp;<input type="button" value="我要打印" onclick="prints()" class="btn" /> &nbsp;&nbsp;<!--<input type="button" value="我要打印" onclick="window.print()" class="btn" />-->
<!--支付宝支付的接口操作，提交的数据-->
